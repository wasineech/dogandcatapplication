...
public class EditPetFragment extends Fragment {
    ...
    ImageView ShowSelectedImage,btn_back;
    Button btnRegister, btnDatePicker, btnImage;
    RadioGroup genderGroup;
    RadioButton genderButtonM,genderButtonF,genderButton;
    //Spinner spnGender;
    String output;
...
//        ShowSelectedImage = getView().findViewById(R.id.imageView);
        ...
        genderButtonM = (RadioButton) getView().findViewById(R.id.male);
        genderButtonF = (RadioButton) getView().findViewById(R.id.female);

        //String s_pet_gender = genderButton.getText().toString();

        if(get_pet_gender.equals("ผู้")){
            genderButtonM.setChecked(true);
        }
        else{
            genderButtonF.setChecked(true);
        }
